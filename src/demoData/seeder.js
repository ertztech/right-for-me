(function attachDemoDataSeeder(root) {
  ...
  function strongFitJob() {
    return {
      ...
      fitAnalysis: fitAnalysis(88, "Apply", [
        ...
        "Profile includes manufacturing and Power BI evidence.",
      ], [
  ...
  function resumeDraft(company) {
    return {
      ...
      markdownContent: `# Alex Morgan\n\nMilwaukee, WI | alex.morgan@example.com | 414-555-0138\n\n## Professional Summary\nOperations and transformation leader with experience in change management, metrics, stakeholder communication, and practical delivery improvement. Tailored for ${company} using demo Profile evidence only.\n\n## Skills & Tools\n- Operations transformation\n- Change management\n- Stakeholder communication\n- Power BI\n- Jira\n\n## Selected Accomplishments\n- Improved delivery cadence by 30% by redesigning weekly operating reviews.\n- Built Power BI dashboards that helped leaders identify bottlenecks and follow-up actions.\n`,
      markdownPreview: "",
      generatedAt: "2026-07-03T12:00:00.000Z",
      promptVersion: "demo-data-v1",
      modelName: "demo",
