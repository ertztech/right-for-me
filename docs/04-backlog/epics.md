...
| Technical Debt | Active | Ongoing improvements that reduce implementation drag. |
| Process Improvements | Active | Workflow and operating system refinements tracked in repo docs. |
